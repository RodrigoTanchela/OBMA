...
int main(int argc, char** argv)
{
    ...
    strcpy(statistic_path, "./");
    //strcat(statistic_path, "statistics/");
    //strcat(statistic_path, dataset);
    //strcat(statistic_path, "/");
    strcat(statistic_path, instance_name);
    strcat(statistic_path, ".sum");

    //if ((sum = fopen(statistic_path, "w")) == NULL)
    //{
    ...
    read_instance();
    setup_data();
    std::vector<double> best_sol_cost(nbr_repeat);
